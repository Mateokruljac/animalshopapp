...
CREATE TABLE `pets_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `pets_tag_owner_id_b138c79b_fk_auth_user_id` (`owner_id`),
  CONSTRAINT `pets_tag_owner_id_b138c79b_fk_auth_user_id` FOREIGN KEY (`owner_id`) REFERENCES `auth_user` (`id`)
...
INSERT INTO `pets_tag` VALUES (1,'Dog',1),(2,'Cat',1);
