...
CREATE TABLE `pets_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `pets_category_owner_id_4b181aba_fk_auth_user_id` (`owner_id`),
  CONSTRAINT `pets_category_owner_id_4b181aba_fk_auth_user_id` FOREIGN KEY (`owner_id`) REFERENCES `auth_user` (`id`)
...
INSERT INTO `pets_category` VALUES (1,'Cat',1),(2,'Dog',1);
